...
public abstract class Move {
    ...
    public Board execute() {
        ...
        //Move the moved piece with this below method
    ...
    public static class PawnPromotion extends Move{
        ...
        public PawnPromotion(final Move decortaedMove) {
            super(decortaedMove.getBoard(), decortaedMove.getMovedPiece(), decortaedMove.getDestinationCoordinate());
            this.decoratedMove = decortaedMove;
    ...
    public static class MoveFactory {
        ...
        public static Move createMove(final Board board,
                                      final int currentCoordinate, final int destinationCoordinate) {
